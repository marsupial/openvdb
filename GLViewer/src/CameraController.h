...
public:
	...
	void getTransformations( Matrix4 &proj, Matrix4 *view = NULL, const Matrix4 *modelIN=0,
	                         Matrix4 *modelView = NULL, Matrix4 *modelViewProj = NULL,
    ...
    float_t coi() const { return mCentreOfInterest; }
