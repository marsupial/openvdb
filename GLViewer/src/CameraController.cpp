...
Box2f CameraController::screenWindow() const
{
...
{
#if 0
  proj = mCamera->projectionMatrix();
  proj[1][1] *= viewPort().aspectRatio();
#else
  proj = projectionMatrix();
#endif
  mCamera->getTransformations(proj, view, modelIN, modelView, modelViewProj, eyeP);
}
