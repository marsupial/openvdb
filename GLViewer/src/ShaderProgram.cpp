...
#define VDB_NUKE_SHADER_LOC     "/Users/jermainedupris/repos/VFX/GLViewer/shaders/"
#define VDB_NUKE_SHADER_HEAD	"#version 150\n"
...
void ShaderProgram::load( const char *fileKey, const Attribute **attrs )
{
    ...
    //
    //glBindFragDataLocation(mProgram, 0, "outputF");
    //
...
{
    glUniform1i(uniformLocation(program, name), value);
}
template<> void ShaderProgram::setUniform<bool>( GLuint program, const char *name, const bool &value )
{
